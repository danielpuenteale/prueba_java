public class HelloWord {
    public static void main(String[] args) {
        ...
        // 7.2 Operador (NOT)
        System.out.println(!true); // Operador NOT
        System.out.println(!false); // Operador NOT

        // 8. Cadenas de texto (Reutilizando y asignando correctamente)
        name = "Dani"; // Reasignamos la variable existente
        var surname = new String("Puente");
        System.out.println("Nombre completo: " + name + " " + surname);

        // 9. Operaciones básicas con cadenas de texto
        System.out.println("Nombre completo: " + name + " " + surname);
